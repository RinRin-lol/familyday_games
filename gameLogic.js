document.addEventListener("DOMContentLoaded", () => {
    ...
    const controlOptionsLowGrade = {
        "ジャンプゲーム": ["タップで ジャンプ", "キーボードの やじるしキー"],
        "めいろゲーム": ["キーボードの やじるしキー", "マウス いどう"],
        "シューティング": ["キーボードの やじるしキー", "がめんじょうの ボタン"],
        "クイズゲーム": ["タップ または クリック"],
        "クリックれんだゲーム": ["タップ または クリック"],
        "たからさがしゲーム": ["キーボードの やじるしキー", "マウス いどう"],
        "いくせいゲーム": ["タップ または クリック", "がめんじょうの ボタン"],
        "よけゲー": ["タップで ジャンプ", "キーボードの やじるしキー"],
        "__other__": ["タップ または クリック", "がめんじょうの ボタン", "キーボードの やじるしキー", "マウス いどう"]
    };
